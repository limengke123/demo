...
import styleClass from './motion-demo3.styl'
...
export default class MotionDemo3 extends React.Component {
    state = {
        mouseXY: [0, 0],
    ...
    render () {
        ...
        return (
            <div className={styleClass["demo2-outer"]}>
                <div className={styleClass.demo2}>
                    <Link to={'/motion'}>回到列表</Link>
                    {
                        order.map((_, key) => {
                            let style, x, y
                                ...
                                <Motion key={key} style={style}>
                                    {
                                        ({translateX, translateY, scale, boxShadow}) =>
                                            <div
                                                ...
                                                className={styleClass["demo2-ball"]}
                                                style={{
